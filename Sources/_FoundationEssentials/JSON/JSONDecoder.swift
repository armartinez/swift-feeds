...
open class JSONDecoder {
    ...
    public var scannerOptions : JSONScanner.Options {
        .init(assumesTopLevelDictionary: self.assumesTopLevelDictionary)
    }

    public var json5ScannerOptions : JSON5Scanner.Options {
        .init(assumesTopLevelDictionary: self.assumesTopLevelDictionary)
    }
    ...
    static public func withUTF8Representation<T>(of jsonData: Data, _ closure: (BufferView<UInt8>) throws -> T ) throws -> T {
...
public class JSONDecoderImpl {
    ...
    public func push(value: __owned JSONMap.Value) {
    ...
    public init(userInfo: [CodingUserInfoKey: Any], from map: JSONMap, codingPathNode: CodingPathNode, options: JSONDecoder.Options) {
...
extension JSONDecoderImpl: Decoder {
    public func container<Key: CodingKey>(keyedBy _: Key.Type) throws -> KeyedDecodingContainer<Key> {
        switch topValue {
    ...
    @inline(__always)
    func checkNotNull<T>(_ value: JSONMap.Value, expectedType: T.Type, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws {
        if case .null = value {
    ...
    @inline(__always)
    func with<T>(value: JSONMap.Value, path: CodingPathNode?, perform closure: () throws -> T) rethrows -> T {
    ...
    func unwrap<T: Decodable>(_ mapValue: JSONMap.Value, as type: T.Type, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> T {
        if type == Date.self {
    ...
    func unwrap<T: DecodableWithConfiguration>(_ mapValue: JSONMap.Value, as type: T.Type, configuration: T.DecodingConfiguration, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> T {
    ...
    private func unwrapDate<K: CodingKey>(from mapValue: JSONMap.Value, for codingPathNode: CodingPathNode, _ additionalKey: K? = nil) throws -> Date {
    ...
    private func unwrapData(from mapValue: JSONMap.Value, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> Data {
    ...
    private func unwrapURL(from mapValue: JSONMap.Value, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> URL {
    ...
    private func unwrapDecimal(from mapValue: JSONMap.Value, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> Decimal {
    ...
    private func unwrapDictionary<T: Decodable>(from mapValue: JSONMap.Value, as type: T.Type, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> T {
    ...
    private func unwrapString(from value: JSONMap.Value, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> String {
    ...
    private func unwrapFloatingPoint<T: PrevalidatedJSONNumberBufferConvertible & BinaryFloatingPoint>(
        ...
        as type: T.Type,
        for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)? = nil) throws -> T
    {
    ...
    static private func _slowpath_unwrapFixedWidthInteger<T: FixedWidthInteger>(as type: T.Type, json5: Bool, numberBuffer: BufferView<UInt8>, fullSource: BufferView<UInt8>, digitBeginning: BufferViewIndex<UInt8>, for codingPathNode: CodingPathNode, _ additionalKey: (some CodingKey)?) throws -> T {
...
extension JSONDecoderImpl {
    struct KeyedContainer<K: CodingKey>: KeyedDecodingContainerProtocol {
        ...
        static func stringify(objectRegion: JSONMap.Region, using impl: JSONDecoderImpl, codingPathNode: CodingPathNode, keyDecodingStrategy: JSONDecoder.KeyDecodingStrategy) throws -> [String:JSONMap.Value] {
        ...
        init(impl: JSONDecoderImpl, codingPathNode: CodingPathNode, region: JSONMap.Region) throws {
            self.impl = impl
            self.codingPathNode = codingPathNode
...
extension JSONDecoderImpl {
    struct UnkeyedContainer: UnkeyedDecodingContainer {
        ...
        init(impl: JSONDecoderImpl, codingPathNode: CodingPathNode, region: JSONMap.Region) {
            self.impl = impl
            self.codingPathNode = codingPathNode
